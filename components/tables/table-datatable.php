...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                                ...
                                <ul class="nk-quick-nav">
                                    ...
                                    <li class="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                            ...
                                            <div class="dropdown-foot center"><a href="apps-chats.html">View
                                                    All</a></div>
                                        </div>
                                    </li>
                                    ...
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            <div class="nk-block-head-sub"><a class="back-to"
                                                    href="components.html"><em
                                                        class="icon ni ni-arrow-left"></em><span>Components</span></a>
                                            </div>
                                            <h2 class="nk-block-title fw-normal">DataTable Example</h2>
                                            <div class="nk-block-des">
                                                <p class="lead">Using <a href="https://datatables.net/"
                                                        target="_blank">DataTables</a>, add advanced interaction
                                                    controls to your HTML tables. It is a highly flexible tool and all
                                                    advanced features allow you to display table instantly and nice way.
                                                </p>
                                                <p>Check out the <a href="https://datatables.net/"
                                                        target="_blank">documentation</a> for a full overview.</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>To intialize datatable with export buttons, use <code
                                                        ...
                                                        your page to active export buttons.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist"
                                                    ...
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Last
                                                                    Login</span></th>
                                                            <th class="nk-tb-col tb-col-md"><span
                                                    ...
                                                    <tbody>
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="35040.34"><span
                                                                    class="tb-amount">35040.34 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+811 847-4958</span>
                                                            </td>
                                                            ...
                                                            <td class="nk-tb-col tb-col-lg"><span>05 Oct 2019</span>
                                                            </td>
                                                            ...
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                                            ...
                                                                            data-bs-placement="top" title="Wallet"><em
                                                                                class="icon ni ni-wallet-fill"></em></a>
                                                                    </li>
                                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                                            class="btn btn-trigger btn-icon"
                                                                            data-bs-toggle="tooltip"
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div
                                                                        class="user-avatar bg-success d-none d-sm-flex">
                                                                        <span>AL</span></div>
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="580.00"><span
                                                                    class="tb-amount">580.00 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+124 394-1787</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                ...
                                                                <ul class="list-status">
                                                                    <li><em
                                                                        ...
                                                                        <span>Email</span></li>
                                                                    <li><em
                                                                            class="icon text-info ni ni-alert-circle"></em>
                                                                        <span>KYC</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"><span>07 Feb 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-warning">Pending</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                                            class="btn btn-trigger btn-icon"
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="32000.34"><span
                                                                    class="tb-amount">32,000.34 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+168 603-2320</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Verified - Kyc Verified">
                                                                <ul class="list-status">
                                                                    <li><em
                                                                            class="icon text-success ni ni-check-circle"></em>
                                                                        <span>Email</span></li>
                                                                    <li><em
                                                                            class="icon text-success ni ni-alert-circle"></em>
                                                                        <span>KYC</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"><span>04 Feb 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success">Active</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="0.00"><span
                                                                    class="tb-amount">0.00 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+439 271-5360</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Unverified - Kyc Unverified">
                                                                <ul class="list-status">
                                                                    <li><em class="icon ni ni-check-circle"></em>
                                                                        <span>Email</span></li>
                                                                    <li><em class="icon ni ni-alert-circle"></em>
                                                                        <span>KYC</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"><span>01 Feb 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-danger">Suspend</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                                            class="btn btn-trigger btn-icon"
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="42.50"><span
                                                                    class="tb-amount">42.50 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+639 130-3150</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Submited - Kyc Unverified">
                                                                <ul class="list-status">
                                                                    <li><em
                                                                            class="icon text-info ni ni-check-circle"></em>
                                                                        <span>Email</span></li>
                                                                    <li><em class="icon ni ni-alert-circle"></em>
                                                                        <span>KYC</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"><span>31 Jan 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success">Active</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="440.34"><span
                                                                    class="tb-amount">440.34 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+963 309-1706</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Submited - Kyc More Info">
                                                                <ul class="list-status">
                                                                    <li><em
                                                                            class="icon text-info ni ni-check-circle"></em>
                                                                        <span>Email</span></li>
                                                                    <li><em
                                                                            class="icon text-warning ni ni-alert-circle"></em>
                                                                        <span>KYC</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"><span>18 Jan 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-info">Inactive</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                                            class="btn btn-trigger btn-icon"
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div
                                                                        class="user-avatar bg-warning d-none d-sm-flex">
                                                                        <span>VL</span></div>
                                                                    <div class="user-info"><span
                                                                            class="tb-lead">Victoria Lynch <span
                                                                                class="dot dot-success d-md-none ms-1"></span></span><span>victoria@example.com</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-mb" data-order="59400.68"><span
                                                                    class="tb-amount">59,400.68 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+811 985-4846</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Verified - Kyc Verified">
                                                                <ul class="list-status">
                                                            ...
                                                            <td class="nk-tb-col tb-col-lg"><span>15 Jan 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success">Active</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="30.00"><span
                                                                    class="tb-amount">30.00 <span
                                                                        class="currency">USD</span></span></td>
                                                            <td class="nk-tb-col tb-col-md"><span>+942 238-4474</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg"
                                                                data-order="Email Verified - Kyc Submited">
                                                                <ul class="list-status">
                                                            ...
                                                            <td class="nk-tb-col tb-col-lg"><span>08 Jan 2020</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md"><span
                                                                    class="tb-status text-success">Active</span></td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            <td class="nk-tb-col nk-tb-col-check">
                                                                <div
                                                                    class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        id="uid12"><label class="custom-control-label"
                                                                        for="uid12"></label></div>
                                                            </td>
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            <td class="nk-tb-col nk-tb-col-check">
                                                                <div
                                                                    class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        id="uid13"><label class="custom-control-label"
                                                                        for="uid13"></label></div>
                                                            </td>
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                ...
                                                <tr class="nk-tb-item nk-tb-head">
                                                    <th class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid"><label class="custom-control-label"
                                                                for="puid"></label></div>
                                                    </th>
                                                    ...
                                                    <th class="nk-tb-col tb-col-md"><em
                                                            class="tb-asterisk icon ni ni-star-round"></em></th>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid1"><label class="custom-control-label"
                                                                for="puid1"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/a.png" alt=""
                                                                class="thumb"><span class="title">Pink Fitness
                                                                Tracker</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3749</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 99.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">49</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Fitbit,
                                                            Tracker</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid2"><label class="custom-control-label"
                                                                for="puid2"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/b.png" alt=""
                                                                class="thumb"><span class="title">Purple
                                                                Smartwatch</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3750</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 89.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">103</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Gadgets,
                                                            Fitbit, Tracker</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                                    class="asterisk-on icon ni ni-star-fill"></em></a>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid3"><label class="custom-control-label"
                                                                for="puid3"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/c.png" alt=""
                                                                class="thumb"><span class="title">Black Mi Band
                                                                Smartwatch</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3751</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 299.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">68</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Smartwatch,
                                                            Tracker</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#" class="active"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                                    class="asterisk-on icon ni ni-star-fill"></em></a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid4"><label class="custom-control-label"
                                                                for="puid4"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/d.png" alt=""
                                                                class="thumb"><span class="title">Black
                                                                Headphones</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3752</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 99.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">77</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Headphone,
                                                            Gadgets</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid5"><label class="custom-control-label"
                                                                for="puid5"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/e.png" alt=""
                                                                class="thumb"><span class="title">iPhone 7
                                                                Headphones</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3753</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 129.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">81</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Headphone,
                                                            Gadgets</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid6"><label class="custom-control-label"
                                                                for="puid6"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/f.png" alt=""
                                                                class="thumb"><span class="title">Purple Blue Gradient
                                                                iPhone Case</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3754</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 29.00</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">28</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Case,
                                                            Gadgets</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid7"><label class="custom-control-label"
                                                                for="puid7"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/g.png" alt=""
                                                                class="thumb"><span class="title">Plug In
                                                                Speaker</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3755</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 19.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">62</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Gadgets,
                                                            Speaker</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid8"><label class="custom-control-label"
                                                                for="puid8"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/h.png" alt=""
                                                                class="thumb"><span class="title">Wireless Waterproof
                                                                Speaker</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3756</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 59.00</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">37</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Speaker,
                                                            Gadgets</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid9"><label class="custom-control-label"
                                                                for="puid9"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/j.png" alt=""
                                                                class="thumb"><span class="title">AliExpress Fitness
                                                                Trackers</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3758</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 35.99</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">145</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Fitbit,
                                                            Tracker</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col nk-tb-col-check">
                                                        <div
                                                            class="custom-control custom-control-sm custom-checkbox notext">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="puid10"><label class="custom-control-label"
                                                                for="puid10"></label></div>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-sm"><span class="tb-product"><img
                                                                src="images/product/i.png" alt=""
                                                                class="thumb"><span class="title">Pool Party Drink
                                                                Holder</span></span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">UY3757</span></td>
                                                    <td class="nk-tb-col"><span class="tb-lead">$ 9.49</span></td>
                                                    <td class="nk-tb-col"><span class="tb-sub">73</span></td>
                                                    <td class="nk-tb-col tb-col-md"><span class="tb-sub">Men,
                                                            Holder</span></td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <div class="asterisk tb-asterisk"><a href="#"><em
                                                                    class="asterisk-off icon ni ni-star"></em><em
    ...
    <script src="assets/js/libs/datatable-btns324d.js?ver=3.1.0"></script>
</body>
</html>